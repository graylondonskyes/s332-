...
`SkyeGateFS13` is the explicit sovereign auth and gateway project for the SkyeHands ecosystem.
...
`kAIxUGateway13` should be treated as the operational ancestor and compatibility base. `SkyeGateFS13` is the named end-state.

Current truth docs:
- `docs/SKYGATEFS13_STATUS_AUDIT.md`
- `docs/SKYGATEFS13_EXECUTION_CHECKLIST.md`
- `docs/SKYGATEFS13_LIVE_VAR_BLOCKERS.md`
- `docs/SKYGATEFS13_OWNERSHIP_BOUNDARY.md`
...
2) **Auth**: customers + sub-keys (many keys per customer)
   - plus central `SkyeGateFS13` identity, session, OAuth/OIDC, JWKS, and app-client authority
3) **Universal caps**: 
...
- `AUTH_EMAIL_WEBHOOK_URL` to deliver verification/reset mail through your provider
