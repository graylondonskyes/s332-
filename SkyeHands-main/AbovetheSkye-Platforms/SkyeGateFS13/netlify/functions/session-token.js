...
import { issueKeyBoundSession } from "./_lib/authBridge.js";
...
export default wrap(async (req) => {
  ...
  const session = await issueKeyBoundSession(keyRow, { ttlSeconds: ttl_seconds, issuer });

  return json(200, {
    token: session.token,
    expires_in: ttl_seconds,
    key_last4: keyRow.key_last4 || null,
    authority: "SkyeGateFS13",
