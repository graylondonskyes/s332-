...
The canonical project is now:

- `AbovetheSkye-Platforms/SkyeGateFS13`

Lineage:

- `SkyeGateFS13` was derived from `AbovetheSkye-Platforms/kAIxUGateway13`
- `kAIxUGateway13` remains the runtime ancestor and compatibility base
- `SkyeGateFS13` is the explicit named end-state and should be the merge target going forward
