...
const DEFAULT_WORKER_URL =
  (import.meta.env.VITE_WORKER_RUNNER_URL as string | undefined) || "https://runner.internal.invalid";
...
function normalizeBaseUrl(raw: string): string {
  ...
  if (!trimmed || trimmed === "https://site.internal.invalid") return window.location.origin;
  return trimmed.replace(/\/+$/, "");
}

function normalizeWorkerUrl(raw: string | null | undefined): string {
  const trimmed = (raw || "").trim();
  if (!trimmed || trimmed === "https://runner.internal.invalid") return KNOWN_WORKER_URL;
...
export function App() {
  ...
  const smokeStaleWarningReason = useMemo(() => {
    ...
    const hasLegacyWorker = workerUrl.includes("kaixu-superide-runner.workers.dev") || workerUrl.includes("runner.internal.invalid");
    if (hasLegacyWorker) {
        ...
        {!adminBoardUnlocked ? (
          ...
          <>
            ...
            <input
              ...
              placeholder="https://site.internal.invalid"
            />
            ...
            <input
              ...
              placeholder="https://runner.internal.invalid"
            />
