...
- Live browser smoke passed against `<local-dev-runtime-url>/index.html`.
...
```bash
tools/browser-smoke/with-repo-chromium.sh node Later-Additions/DonorCode-MySkyeApps/SuperIDEv3/SuperIDEv3/SkyeDocxMax/smoke-full-standalone.mjs <local-dev-runtime-url>/index.html
```
