import { json, noContent, parseBody, requireMember, readAppState, upsertAppState } from './_lib/kaixu-platform.js';

function resolveAppKey(event, body = {}) {
  const query = event?.queryStringParameters || {};
  return String(body.app_key || query.app_key || body.route || '/').slice(0, 240);
}
