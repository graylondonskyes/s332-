...
def public_base_url() -> str:
    return str(os.getenv("APP_BASE_URL", "https://app.internal.invalid")).rstrip("/")
...
def send_via_smtp(payload: dict[str, Any]) -> tuple[str, str, str]:
    ...
    smtp_from = os.getenv('SMTP_FROM_EMAIL', smtp_username or os.getenv('APP_SUPPORT_EMAIL', '')).strip()
