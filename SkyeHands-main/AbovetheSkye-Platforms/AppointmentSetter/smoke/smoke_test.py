...
os.environ["APP_SUPPORT_EMAIL"] = "ops-smoke@internal.invalid"
os.environ["APP_SUPPORT_PHONE"] = "+14805550126"
os.environ["ADMIN_BOOTSTRAP_EMAIL"] = "admin-smoke@internal.invalid"
os.environ["ADMIN_BOOTSTRAP_PASSWORD"] = "Admin-Smoke!42"
os.environ["VIEWER_BOOTSTRAP_EMAIL"] = "viewer-smoke@internal.invalid"
os.environ["VIEWER_BOOTSTRAP_PASSWORD"] = "Viewer-Smoke!42"
...
def main() -> None:
    ...
    try:
        ...
        login, login_headers = request_json(
            "/api/auth/login",
            method="POST",
            payload={"email": os.environ["ADMIN_BOOTSTRAP_EMAIL"], "password": os.environ["ADMIN_BOOTSTRAP_PASSWORD"]},
        )
        ...
        changed, _ = request_json(
            ...
            method="POST",
            payload={
                "current_password": os.environ["ADMIN_BOOTSTRAP_PASSWORD"],
        ...
        cloned_org, _ = request_json(
            ...
            payload={
                ...
                "support_email": "branch@internal.invalid",
        ...
        created_org, _ = request_json(
            ...
            payload={
                ...
                "support_email": "scottsdale@internal.invalid",
        ...
        settings_saved, _ = request_json(
            ...
            method="POST",
            payload={
                "support_email": "desk@internal.invalid",
        ...
        stale_lead = db.create_lead({
            "name": "Autonomy Lead",
            "email": "autonomy@internal.invalid",
            "phone": "555-777-1000",
        ...
        inbound_email, _ = request_json(
            "/api/inbound/email",
            method="POST",
            payload={"from": "jordan@internal.invalid", "to": os.environ["APP_SUPPORT_EMAIL"], "subject": "Need a new time", "body": "I need to reschedule my appointment.", "lead_id": lead_id},
        ...
        viewer_login, viewer_headers = request_json(
            "/api/auth/login",
            method="POST",
            payload={"email": os.environ["VIEWER_BOOTSTRAP_EMAIL"], "password": os.environ["VIEWER_BOOTSTRAP_PASSWORD"]},
        )
        ...
        request_json(
            ...
            method="POST",
            payload={
                "current_password": os.environ["VIEWER_BOOTSTRAP_PASSWORD"],
