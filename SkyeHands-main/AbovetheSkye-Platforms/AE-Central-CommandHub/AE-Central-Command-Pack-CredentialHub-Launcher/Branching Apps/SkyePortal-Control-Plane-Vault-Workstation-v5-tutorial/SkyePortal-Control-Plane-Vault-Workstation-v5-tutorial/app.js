...
(() => {
  ...
  const BRAND = {
    ...
    site: "https://internal.invalid",
    emailPrimary: "vault-primary@internal.invalid",
    emailSecondary: "vault-secondary@internal.invalid",
    phoneDisplay: "(555) 010-0248",
    phoneLink: "+15550100248"
  };
  ...
  async function seedFounderKit() {
    ...
    if (!hasContact) {
      state.data.contacts.unshift({
        ...
        company: "Internal Tutorial Workspace",
        role: "Founder",
    ...
    if (!hasApp) {
      state.data.apps.unshift({
        id: uid("app"),
        name: "Internal Workspace Hub",
        appId: "internal-workspace-hub",
        url: BRAND.site,
        defaultProjectId: "",
