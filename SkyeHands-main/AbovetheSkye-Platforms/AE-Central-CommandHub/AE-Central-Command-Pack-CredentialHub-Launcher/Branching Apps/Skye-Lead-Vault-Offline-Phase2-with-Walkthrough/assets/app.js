  ...
  function seedLeads(){
    ...
    return [
      normalizeLead({
        ...
        updated_at:created,
        contacts:[
          { id:uid(), name:'Marcus', role:'Owner', email:'marcus@internal.invalid', phone:'(602) 555-0148', decision:'Decision maker', notes:'Moves quickly when shown clean visuals.' },
      ...
      normalizeLead({
        ...
        email:'jasmine@internal.invalid',
        phone:'(480) 555-0126',
        website:'https://internal.invalid',
        ...
        updated_at:created,
        contacts:[
          { id:uid(), name:'Jasmine', role:'Practice manager', email:'jasmine@internal.invalid', phone:'(480) 555-0126', decision:'Champion', notes:'Wants to move before month end.' },
      ...
      normalizeLead({
        ...
        updated_at:created,
        contacts:[
          { id:uid(), name:'Andre', role:'Owner', email:'andre@internal.invalid', phone:'(623) 555-0182', decision:'Decision maker', notes:'Prefers text before calls.' }
        ],
        tasks:[],
        logs:[
  ...
  function defaultState(){
    ...
    return {
      ...
      settings:{
        ...
        signature:'Internal Tutorial Ops\n(555) 010-0146\nops@internal.invalid',
