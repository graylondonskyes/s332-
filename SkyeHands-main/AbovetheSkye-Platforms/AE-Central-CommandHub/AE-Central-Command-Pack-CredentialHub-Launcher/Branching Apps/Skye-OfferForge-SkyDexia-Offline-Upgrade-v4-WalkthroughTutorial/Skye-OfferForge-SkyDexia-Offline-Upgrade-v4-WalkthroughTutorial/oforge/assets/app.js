...
const DemoSeed = {
  settings: {
    ...
    companyName: 'Internal Tutorial Studio',
    founderName: 'Internal Tutorial Operator',
    email: 'offers@internal.invalid',
    phone: '(555) 010-0199',
    website: 'internal.invalid',
    city: 'Phoenix, AZ',
    currency: 'USD',
    defaultTaxRate: 8.6,
...
<body>
  <div class="wrap">
    ...
    <section class="section footer">
      <div><strong>Contact</strong> · ${escapeHtml(payload.brand?.companyName || 'Internal Tutorial Studio')} · ${escapeHtml(payload.brand?.email || 'offers@internal.invalid')} · ${escapeHtml(payload.brand?.phone || '(555) 010-0199')} · ${escapeHtml(payload.brand?.website || 'internal.invalid')}</div>
