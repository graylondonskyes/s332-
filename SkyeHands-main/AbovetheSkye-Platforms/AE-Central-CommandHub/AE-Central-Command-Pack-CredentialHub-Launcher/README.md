...
- `../ESTATE_CLASSIFICATION.md`

Read that file before representing this folder as a shipped app suite. The
launcher is real, but many bundled lanes are walkthrough or packaging surfaces,
not independently smoke-certified products.
