(function(){
  ...
  function bind(){
    ...
    on('arf77_rbac_audit', async function(){ var res = await window.RoutexSharedAppFabricV77.auditRbac(); out(res.audit || res); rerender(); });
    on('arf77_tenant_audit', async function(){ var res = await window.RoutexSharedAppFabricV77.auditTenant(); out(res.audit || res); rerender(); });
