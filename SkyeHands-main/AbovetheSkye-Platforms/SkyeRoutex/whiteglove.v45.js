...
(function(){
  ...
  if(window.SKYE_ROUTEX_ENABLE_INTERNAL_LABS !== true) return;
  ...
  function runScenarioWebsiteOrigin(){
    ...
    const profile = ensureServiceProfile({ profileType:'executive', displayName:'Website Origin Executive', legalName:'Website Origin Executive', primaryPhone:'602-000-4504', email:'website.origin@internal.invalid', addresses:'Phoenix Convention Center\nScottsdale Quarter', preferredZone:'phoenix', serviceArea:'phoenix', assistanceNotes:'Meet/greet sign required', accessNotes:'Call assistant if delayed', favoriteDriverIds:driver.id, householdAuthorizedRiders:'', billingPreference:'receipt', receiptDestination:'assistant@internal.invalid', temperature:'cool', music:'none', quietRide:true, luggageHelp:true, groceryHelp:false, callTextPreference:'text', notesHistory:'Website-origin scenario seed' });
