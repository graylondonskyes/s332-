...
- This folder proves the local directive/test shell only. Remote gateway health, auth allowlisting, and provider execution remain external runtime concerns.
