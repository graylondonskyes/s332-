...
export declare class TabBarRenderer extends TabBar.Renderer {
    ...
    constructor(contextMenuRenderer?: ContextMenuRenderer | undefined, decoratorService?: TabBarDecoratorService | undefined, iconThemeService?: IconThemeService | undefined, selectionService?: SelectionService | undefined, commandService?: CommandService | undefined, corePreferences?: CorePreferences | undefined, hoverService?: HoverService | undefined, contextKeyService?: ContextKeyService | undefined);
    dispose(): void;
...
export declare class ToolbarAwareTabBar extends ScrollableTabBar {
    ...
    constructor(tabBarToolbarRegistry: TabBarToolbarRegistry, tabBarToolbarFactory: () => TabBarToolbar, breadcrumbsRendererFactory: BreadcrumbsRendererFactory, options?: TabBar.IOptions<Widget>, scrollbarOptions?: PerfectScrollbar.Options, dynamicTabOptions?: ScrollableTabBar.Options);
...
export declare class SideTabBar extends ScrollableTabBar {
     ...
     */
    readonly collapseRequested: any;
    /**
     * Emitted when the set of overflowing/hidden tabs changes.
     */
    readonly tabsOverflowChanged: any;
    protected mouseData?: {
        pressX: number;
        pressY: number;
     ...
     */
    protected onDragEnter: (event: Drag.Event) => void;
    /**
