...
function withBootDefaults(baseEnv = process.env) {
  return {
    ...
    SKYGATEFS13_GATE_TOKEN: String(baseEnv.SKYGATEFS13_GATE_TOKEN || baseEnv.SKYGATE_GATE_TOKEN || baseEnv.SKYEQUANTA_GATE_TOKEN || baseEnv.SKYEQUANTA_OSKEY || 'cold-machine-gate-token').trim(),
    SKYGATEFS13_ORIGIN: String(baseEnv.SKYGATEFS13_ORIGIN || baseEnv.SKYGATE_AUTH_ORIGIN || baseEnv.SKYGATE_ORIGIN || baseEnv.SKYEQUANTA_GATE_URL || baseEnv.OMEGA_GATE_URL || 'http://127.0.0.1:5999').trim(),
    SKYGATEFS13_GATE_MODEL: String(baseEnv.SKYGATEFS13_GATE_MODEL || baseEnv.SKYGATE_GATE_MODEL || baseEnv.SKYEQUANTA_GATE_MODEL || 'kaixu/deep').trim() || 'kaixu/deep',
    SKYEQUANTA_GATE_TOKEN: String(baseEnv.SKYGATEFS13_GATE_TOKEN || baseEnv.SKYGATE_GATE_TOKEN || baseEnv.SKYEQUANTA_GATE_TOKEN || baseEnv.SKYEQUANTA_OSKEY || 'cold-machine-gate-token').trim(),
    SKYEQUANTA_GATE_URL: String(baseEnv.SKYGATEFS13_ORIGIN || baseEnv.SKYGATE_AUTH_ORIGIN || baseEnv.SKYGATE_ORIGIN || baseEnv.SKYEQUANTA_GATE_URL || baseEnv.OMEGA_GATE_URL || 'http://127.0.0.1:5999').trim(),
    SKYEQUANTA_GATE_MODEL: String(baseEnv.SKYGATEFS13_GATE_MODEL || baseEnv.SKYGATE_GATE_MODEL || baseEnv.SKYEQUANTA_GATE_MODEL || 'kaixu/deep').trim() || 'kaixu/deep'
  };
}
