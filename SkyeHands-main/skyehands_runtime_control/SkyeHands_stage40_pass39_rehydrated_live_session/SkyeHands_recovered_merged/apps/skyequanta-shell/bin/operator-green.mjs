...
function withOperatorDefaults(env = process.env) {
  return {
    ...
    SKYGATEFS13_GATE_TOKEN: String(env.SKYGATEFS13_GATE_TOKEN || env.SKYGATE_GATE_TOKEN || env.SKYEQUANTA_GATE_TOKEN || env.SKYEQUANTA_OSKEY || 'cold-machine-gate-token').trim(),
    SKYGATEFS13_ORIGIN: String(env.SKYGATEFS13_ORIGIN || env.SKYGATE_AUTH_ORIGIN || env.SKYGATE_ORIGIN || env.SKYEQUANTA_GATE_URL || env.OMEGA_GATE_URL || 'http://127.0.0.1:5999').trim(),
    SKYGATEFS13_GATE_MODEL: String(env.SKYGATEFS13_GATE_MODEL || env.SKYGATE_GATE_MODEL || env.SKYEQUANTA_GATE_MODEL || 'kaixu/deep').trim() || 'kaixu/deep',
    SKYEQUANTA_GATE_TOKEN: String(env.SKYGATEFS13_GATE_TOKEN || env.SKYGATE_GATE_TOKEN || env.SKYEQUANTA_GATE_TOKEN || env.SKYEQUANTA_OSKEY || 'cold-machine-gate-token').trim(),
    SKYEQUANTA_GATE_URL: String(env.SKYGATEFS13_ORIGIN || env.SKYGATE_AUTH_ORIGIN || env.SKYGATE_ORIGIN || env.SKYEQUANTA_GATE_URL || env.OMEGA_GATE_URL || 'http://127.0.0.1:5999').trim(),
    SKYEQUANTA_GATE_MODEL: String(env.SKYGATEFS13_GATE_MODEL || env.SKYGATE_GATE_MODEL || env.SKYEQUANTA_GATE_MODEL || 'kaixu/deep').trim() || 'kaixu/deep'
  };
}
