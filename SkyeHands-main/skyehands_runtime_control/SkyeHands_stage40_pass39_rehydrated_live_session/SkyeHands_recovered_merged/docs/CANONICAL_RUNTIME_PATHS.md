...
This file defines the single authoritative product truth path for the SkyeHands Runtime Control surface.
...
- Purpose: owns the public runtime contract, product identity endpoint, status endpoint, workspace routes, control-plane surface, and parent `SkyeGateFS13` bridge.
