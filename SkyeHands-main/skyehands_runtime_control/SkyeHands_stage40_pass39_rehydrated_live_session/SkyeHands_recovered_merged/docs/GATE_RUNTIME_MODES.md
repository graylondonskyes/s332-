...
- optional preferred model var: `SKYGATEFS13_GATE_MODEL` or `SKYGATE_GATE_MODEL`
- legacy compatibility vars still work: `SKYEQUANTA_GATE_URL`, `OMEGA_GATE_URL`, `SKYEQUANTA_GATE_TOKEN`, `SKYEQUANTA_OSKEY`, `SKYEQUANTA_GATE_MODEL`
