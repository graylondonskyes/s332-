...
import { FileDeleteOptions, FileOverwriteOptions, FileSystemProvider, FileType, FileWriteOptions, Stat, WatchOptions } from '../common/files';
import { URI, Disposable } from '@theia/core';
...
export declare class VSCodeFileSystemProvider implements FileSystemProvider {
    ...
    protected readonly onDidChangeFileEmitter: any;
