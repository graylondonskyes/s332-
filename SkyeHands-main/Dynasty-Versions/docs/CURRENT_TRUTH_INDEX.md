...
- `docs/hardening/SECTION_64_SUPERAPP_INHERITANCE_AND_VISUAL_ANALYTICS_DIRECTIVE.md` — directive load-in for imported-platform super-app inheritance and AE Flow visual analytics expansion under SkyeQuanta core.
