...
function checkNodeVersion() { const major = Number.parseInt(process.versions.node.split('.')[0], 10); return { label: 'node-version', ok: Number.isInteger(major) && major >= 18, detail: `${process.versions.node} (>=18 supported by bundled in-house runtime)` }; }
