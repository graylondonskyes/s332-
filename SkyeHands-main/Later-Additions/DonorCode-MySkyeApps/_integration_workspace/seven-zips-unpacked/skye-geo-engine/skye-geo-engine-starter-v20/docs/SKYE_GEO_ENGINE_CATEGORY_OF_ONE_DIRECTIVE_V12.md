# SKYE GEO ENGINE — CATEGORY-OF-ONE BUILD DIRECTIVE V12
...
- `scripts/scan-ui.mjs`
- `scripts/scan-no-demo-residue.mjs`
- `docs/SKYE_GEO_ENGINE_CATEGORY_OF_ONE_DIRECTIVE_V9.md`
- `docs/SMOKE_PROOF_PHASE_I_V9.md`
- `docs/VALUATION_DELTA_V9.md`
- `docs/SKYE_GEO_ENGINE_CATEGORY_OF_ONE_DIRECTIVE_V12.md`
- `docs/SMOKE_PROOF_PHASE_K_V12.md`
- `docs/VALUATION_DELTA_V12.md`
...
- ✅ Core smoke lanes for audit/research/publish/reporting/readiness/strategy now run against a local fixture server instead of inline mock-fetch scaffolding
