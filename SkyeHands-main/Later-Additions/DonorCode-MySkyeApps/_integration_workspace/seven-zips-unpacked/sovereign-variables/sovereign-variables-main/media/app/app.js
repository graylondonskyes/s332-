...
(function(){
  ...
  async function callApi(path, body){
    if (extensionHost) throw new Error('External route lanes are disabled in the Open VSX extension build. Use the standalone static app for hosted route lanes.');
